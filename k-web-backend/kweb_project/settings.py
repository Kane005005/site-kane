"""
Django settings for kweb_project project.
...
ALLOWED_HOSTS = ['kweb.pythonanywhere.com']
...
# Adresses où les emails du formulaire de contact seront envoyés
CONTACT_FORM_RECIPIENT = 'traorekanz@gmail.com' # <-- Remplace par ton adresse email
